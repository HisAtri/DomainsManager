...
GLOBAL_SETTINGS = (
    ...
    integer("task_max_attempts", "刷新任务", "最大重试次数", "刷新任务发生可恢复错误时的最多尝试次数。", 1, 100, unit="次"),
    ...
    integer("scheduler_batch_size", "调度", "单次调度数量", "Scheduler 一次领取的最大域名数量。", 1, 1000, unit="个"),
    ...
    integer("notification_max_attempts", "通知", "通知最大重试次数", "通知投递失败后的最大尝试次数。", 1, 100, unit="次"),
    ...
    integer("smtp_port", "邮件投递", "SMTP服务器端口", "", 1, 65535, unit="端口"),
