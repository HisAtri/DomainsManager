...
from domainsmanager_api.global_setting_registry import GLOBAL_SETTING_BY_KEY, SITE_SETTINGS
...
async def get_public_site_config(
    ...
    return PublicSiteConfig(
        revision=revision, registration_enabled=registration_enabled, **values
    )
