...
def domain_response(record: ManagedDomainRecord) -> ManagedDomainResponse:
    return ManagedDomainResponse(
        ...
        registry_expires_at=record.registry_expires_at,
        registrar_expires_at=record.registrar_expires_at,
        expiration_status=record.expiration_status,
        expiration_checked_at=record.expiration_checked_at,
        registrar_rdap_url=record.registrar_rdap_url,
