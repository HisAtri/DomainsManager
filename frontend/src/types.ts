...
export type Task = { id: string; status: "queued" | "running" | "succeeded" | "failed" | "cancelled"; domain_id: string; check_id: string | null; error: { code: string; message: string } | null; created_at: string; started_at: string | null; completed_at: string | null; updated_at: string };
